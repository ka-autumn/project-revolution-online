import type { Ability, DreamAbility, GenkiAbility, HopeAbility, TrustAbility } from './ability.js'
 ...
 */
function hasKeyword(card: Card, keyword: (DreamAbility | GenkiAbility | TrustAbility)['keyword']): boolean {
