 ...
 * （総合ルール 第4部 第3章 1）。
 *
 * 並びは、ターンの中で起こる順。ターンの進行に伴って起こるもの、ユニットの登場・移動、
 * バトルの中で起こるもの、ターンの中の一点に置けないものを持つ。スマッシュ判定の
 * できごと、リリースした時（同 第3部 第5章 1）・カードを引いた時（同 第6章 1-1）といった、
 * そこで起きる行動に伴うできごとは、その行動を実装する時に足す。
 */
