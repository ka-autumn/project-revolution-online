...
export { applyMove, legalMoves } from './legal-move.js'
export type { Move } from './legal-move.js'
...
export { randomChooser, playRandomSelfPlay } from './self-play.js'
export type { SelfPlayOptions, SelfPlayResult } from './self-play.js'
