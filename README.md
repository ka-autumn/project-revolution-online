...
**`VITE_SERVER_URL` を変えたら、配り直すまで反映されない。** ブラウザ 2 つで、同じ部屋の
合言葉・違う名乗りで開く。焼いた先とは違うところへ繋ぎたいときは `?server=` で上書きできる。

```
https://<画面>/?participant=あ&room=あいことば
https://<画面>/?participant=い&room=あいことば
```
